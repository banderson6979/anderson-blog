...
{<img src="https://travis-ci.org/banderson6979/simple-blog.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/banderson6979/simple-blog]
...
Rails '>= 4.2.7.1' and Ruby '>= 2.1.0p0'
